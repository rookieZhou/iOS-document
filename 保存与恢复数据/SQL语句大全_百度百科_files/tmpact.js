...
var show = 1; //是否展示，0是不展示，1是展示，2只在首页展示，3只在词条页展示
	...
	var linkSrc2 = 'http://baike.baidu.com/cms/s/banner/world200x100.jpg';//图片的地址 
	var linkHref2 = 'http://baike.baidu.com/subview/1229527/14188812.htm';//图片的链接
	var linkText2 = '不做伪球迷，我是真懂球';//鼠标滑过信息
	var isLink2 = true;
	var isFlash2 = true;
